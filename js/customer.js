...
function setangle(slat, slong, dlat, dlong) {
	  ...
	  var dLat = deg2rad(19.0176-18.520430299999997);  // deg2rad below
	  var dLon = deg2rad(72.8562-73.8567437); 
	  var a = 
	    Math.sin(dLat/2) * Math.sin(dLat/2) +
	    Math.cos(deg2rad(18.520430299999997)) * Math.cos(deg2rad(19.0176)) * 
